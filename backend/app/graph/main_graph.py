...
def build_graph() -> StateGraph:
    ...
    def orchestrator_input_mapper(state: GraphState) -> dict[str, Any]:
        return {
            ...
            "_hot_topics_metrics": state.get("_hot_topics_metrics", {}),
            "_session_intent_frame": state.get("_session_intent_frame", {}),
            "_session_last_run_ref": state.get("_session_last_run_ref", {}),
        }
